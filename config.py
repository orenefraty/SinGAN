...
def get_arguments():
    ...
    parser.add_argument('--min_size',type=int,help='image min size at the coarser scale',default=25)
    parser.add_argument('--max_size', type=int,help='image max size at the coarser scale', default=250)
